...
function Blog({ blogs }) {
  ...
  return (
    <div id='blogs' className="relative z-50 border-t my-12 lg:my-24 border-emerald-500/30">
      <div className="w-[100px] h-[100px] bg-emerald-400/20 rounded-full absolute top-6 left-[42%] translate-x-1/2 filter blur-3xl  opacity-30"></div>
      ...
      <div className="flex justify-center  mt-5 lg:mt-12">
        <Link
          className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-emerald-500 to-cyan-600 px-3 md:px-8 py-3 md:py-4 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold hover:from-emerald-400 hover:to-cyan-500"
          role="button"
          href="/blog"
        >
          <span>View More</span>
